...
myChart.on("mapselectchanged", function (param){ 
    console.log(param)
    var selectedProvince = provinces[param.name];

    $.get('https://rawgit.com/ecomfe/echarts/master/map/json/province/'+selectedProvince+'.json', function (json) {
        $("#prov").html(param.name);
        echarts.registerMap(param.name, json); 
...
$("#all").on('click',function() {
    $.get('https://rawgit.com/ecomfe/echarts/master/map/json/china.json', function (json) {
...
$("#prov").on('click',function() {
    var selectedProvince = provinces[$("#prov").html()];
    $.get('https://rawgit.com/ecomfe/echarts/master/map/json/province/'+selectedProvince+'.json', function (json) {
        echarts.registerMap($("#prov").html(), json); 
